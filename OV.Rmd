...
```{r}
ggplot(data=eignir, aes(eignir$svfn, fill=teg_eign_groft)) + geom_bar()
```
...
ggplot(data=eignir, aes(x=eignir$fermetraverd, fill=eignir$svfn)) + geom_histogram() 

ggplot(data=eignir, aes(x=eignir$kaupverd, fill=eignir$svfn)) + geom_histogram()
...
```{r}
ggplot(data=ov,aes(x=byggar,y=birtm2)) + geom_point()
```
